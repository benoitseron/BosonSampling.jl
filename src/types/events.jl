...
struct Event{TIn<:InputType, TOut<:OutputMeasurementType}
    ...
    output_measurement::TOut
    proba_params::EventProbability
    interferometer::Union{Interferometer, NonLinearInterferometer}

    function Event{TIn, TOut}(input_state, output_measurement, interferometer::Union{Interferometer, NonLinearInterferometer}, proba_params = nothing) where {TIn<:InputType, TOut<:OutputMeasurementType}
    ...
    Event(i,o,interf::Union{Interferometer, NonLinearInterferometer},p = nothing) = Event{get_parametric_type(i)[1], get_parametric_type(o)[1]}(i,o,interf,p)
